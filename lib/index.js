...
class WebImage extends React.Component {
  static propTypes = {
     ...
     *   nativeEvent
     *   nativeEvent.source
     *   nativeEvent.source.uri - URL of the loaded image
     *   nativeEvent.source.width - width of the loaded image
     *   nativeEvent.source.height - height of the loaded image
     */
  ...
  render () {
    ...
    return <WebImageView {...props} source={resolvedSource} onWebImageError={this._onError} onWebImageLoad={this._onLoad} />
  }
...
var WebImageView = requireNativeComponent('WebImageView', WebImage, {
  nativeOnly: {onWebImageError: true, onWebImageLoad: true}
})
